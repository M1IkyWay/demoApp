...
class SlotMachineView (context : Context, attributeSet: AttributeSet?) : LinearLayout (context, attributeSet) {
    ...
    val imagesList = mutableListOf(image0, image1, image2, image3, image4)
    ...
    init {
        ...
        binding.column1.setOnTouchListener {_, event ->
            when (event.action) {
